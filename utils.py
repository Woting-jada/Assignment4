...
def create_data_lists(voc07_test_path, voc07_train_path, output_folder):
    """
    ...
    voc07_train_path = os.path.abspath(voc07_train_path)
    ...
    for id in ids:
        # Parse annotation's XML file
        if os.path.exists(os.path.join(voc07_test_path, 'Annotations', id + '.xml'))==False:
            continue
